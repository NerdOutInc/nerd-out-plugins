...
import { CoordinatedNodeOAuthClientProvider } from './lib/coordinated-node-oauth-client-provider'
...
async function runProxy(
  ...
  const authProvider = new CoordinatedNodeOAuthClientProvider({
    authorizeResource: authorizeResource || serverUrl,
  ...
  // Create a lazy auth coordinator after the provider so callbacks can be
  // bound to this process's exact OAuth state.
